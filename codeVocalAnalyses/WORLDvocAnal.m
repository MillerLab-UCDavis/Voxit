function [S] = WORLDvocAnal(filein,overwrite)
% Analyze vocal parameters using a WORLD  file
% INPUTS
%    filein:  WORLD object mat file
%    overwrite: overwrite existing WORLD object file with additional field for analysis results (Default: 0)
%
% OUTPUTS
%   S:      WORLD object structure with additional analysis field
%
%
% copyright Lee M. Miller 2016, latest mods 01/2019 version1.1
...
S.analysis.README = {['WORLDvocAnal.m ' date]};
...
S.analysis.IntensitySegmentMeanSD = std(IsegmentMeans);
...
%% OVERWRITE WORLD OBJECT FILE with new fields included
S.analysis.vuv = vuv;
S.analysis.sps = sps;

if overwrite
    disp('Overwriting WORLD object file with new fields')
    save(filein,'S','-v7.3');
end

end %function WORLDvocAnal
