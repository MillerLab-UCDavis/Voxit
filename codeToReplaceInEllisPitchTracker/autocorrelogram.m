...
%    disp(['nfrms=',num2str(nfrms),' len(xx)=',num2str(length(xx))]);
    [c, s]= autocorr(xx,frmL,nfrms,maxlags,winL); %LMM this is not an mfile in the repo. Dan instructs to compile from https://github.com/dpwe/calc_sbpca/blob/master/autocorr.c 
